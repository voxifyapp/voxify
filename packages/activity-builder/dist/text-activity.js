...
class TextActivity extends activity_1.Activity {
    constructor(data) {
        super(activity_1.ActivityType.TEXT, data
            ? Object.assign(Object.assign({}, data), { title: new text_block_1.TextBlock(data.title.text, data.title), description: new text_block_1.TextBlock(data.description.text, data.description) }) : { title: new text_block_1.TextBlock(""), description: new text_block_1.TextBlock("") });
    }
    setTitle(title) {
