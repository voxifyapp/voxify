...
describe('FillInTheBlanksActivity', () => {
    ...
    it('should be able to set question, options and answer', () => {
        ...
        expect(activity.getAnswer()).toEqual({[activity.getOptions()[0].id]: "Option 1"});
    })
    ...
    it('should be able to create from existing data', () => {
        ...
        const activity2 = new FillInTheBlanksActivity(JSON.parse(JSON.stringify( activity.getData())));
    ...
    it('should be able to return wrong blanks', () => {
        ...
        expect(activity.checkAnswer({blank1:activity.getOptions()[1].id})).toEqual(["blank1"]);
    })
    ...
    it('should return empty array if correct', () => {
        ...
        expect(activity.checkAnswer({blank1:activity.getOptions()[0].id})).toEqual([]);
    })
})