...
import { useCreateVideoContext } from "@voxify/components/ActivityRenderer/Video/video.context";
import { ActivityResponseResultType } from "@voxify/types/lms-progress/activity-response";
import { Video as ExpoVideo, ResizeMode } from "expo-av";
import React, { useEffect, useRef } from "react";
import { Pressable, StyleSheet } from "react-native";
import { ButtonIcon, Progress, XStack, YStack, ZStack } from "tamagui";
...
export const getVideoUrlFromFileName = (fileName: string): string => {
  return `${process.env.EXPO_PUBLIC_ACTIVITY_VIDEO_URL}/${fileName}.mp4`;
};
