...
export class CreateActivity1695607574242 implements MigrationInterface {
    name = 'CreateActivity1695607574242'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "activity" ADD "heading" text NOT NULL`);
        await queryRunner.query(`COMMENT ON COLUMN "activity"."heading" IS 'The heading of the activity'`);
        ...
        await queryRunner.query(`ALTER TABLE "activity" ALTER COLUMN "type" TYPE "public"."activity_type_enum" USING "type"::"text"::"public"."activity_type_enum"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."activity_type_enum_old" AS ENUM('VIDEO', 'FILL_IN_THE_BLANKS', 'MULTIPLE_CHOICE', 'PRONUNCIATION', 'FORM_A_SENTENCE')`);
        await queryRunner.query(`ALTER TABLE "activity" ALTER COLUMN "type" TYPE "public"."activity_type_enum_old" USING "type"::"text"::"public"."activity_type_enum_old"`);
