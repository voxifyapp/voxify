...
export class CreateCourseEnrollment1691409811569 implements MigrationInterface {
  name = 'CreateCourseEnrollment1691409811569';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "lesson" ADD CONSTRAINT "FK_2e4ec2ae66c028d3b20f8ff0eb9" FOREIGN KEY ("unitId") REFERENCES "unit"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
